...

{
  ...
  // This fork is Gmail only: a provider another build knew is Gmail here too.
  assert.strictEqual(accounts.makeAccount({ email: "j@x.com", provider: "IMAP" }).provider, "gmail")
  assert.strictEqual(accounts.makeAccount({ email: "j@x.com", provider: " hey " }).provider, "gmail")
